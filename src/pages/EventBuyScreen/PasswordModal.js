...
export default function PasswordModal({passwordModal,handleClose}) {
    ...
    >
      <div style={{backgroundColor:"#000000"}} className="w-80 p-8 rounded-xl">
        ...
        <TextField
          ...
          fullWidth
        />
        <div style={{backgroundColor:"#074286"}} className="flex justify-center items-center p-3 mt-8 rounded-lg">Submit</div>
